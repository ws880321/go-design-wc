...
export const ArrowRight = (props: Record<string, any> = {}) =>
    h(
        ...
        {
            ...svgBaseProp,
            class: props?.class ? `go-icon ${props.class}` : 'go-icon'
        },
        h('path', {
            fill: 'currentColor',
...
export const Loading = (props: Record<string, any> = {}) =>
    h(
        'svg',
        { ...svgBaseProp, class: props?.class ? `go-icon ${props.class}` : 'go-icon' },
        h('path', {
            fill: 'currentColor',
...
export const CaretRight = (props: Record<string, any> = {}) => {
    return (
        <svg {...svgBaseProp} class={props?.class ? `go-icon ${props.class}` : 'go-icon'}>
